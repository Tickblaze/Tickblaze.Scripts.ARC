...
public class CachedSeriesTransform<TSource, TDestination> : ISeries<TDestination>
{
    public CachedSeriesTransform(ISeries<TSource> sourceSeries, Func<TSource, TDestination> selector)
    {
	...
	public CachedSeriesTransform(ISeries<TSource> sourceSeries, Func<int, TSource, TDestination> selector)
	{
		_selector = selector;
    ...
    private TDestination GetDestination(int index)
    {
		...
		TDestination GetDestinationValue()
		{
            ...
            return _selector(index, sourceValue);
		}
	}
